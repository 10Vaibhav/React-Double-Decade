...
export default function FeatureFlags(){
    ...
    return <div className="w-[1200px] h-[900px] bg-white px-4 py-4 space-y-3 flex flex-col justify-center items-center">
        <h1 className="font-bold">Feature Flags</h1>
        <p>It shows Feature, that we want to show through API.</p>
        {
